                      ...
                      <div class="tab-content tab-space">
                          <div class="tab-pane active" id="yayasan">
                            ...
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Foto Struktur</label>
                              <div class="col-sm-10">
                                <img class="w-50" src="{{ url('dashboard/img/struktur/'.$yayasan->foto_struktur) }}">
                              </div>
                            </div>
                            <!-- modalyayasan -->
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ url('ubahstrukturyayasan') }}" class="form-data" id="form-jadwal" enctype="multipart/form-data">
                                          @csrf
                                        <div>
                                        <label for="foto_struktur" class="control-label">Ganti Foto</label>
                          ...
                          <div class="tab-pane" id="tk">
                            ...
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Foto Struktur</label>
                              <div class="col-sm-10">
                                <img class="w-50" src="{{ url('dashboard/img/struktur/'.$tk->foto_struktur) }}">
                              </div>
                            </div>
                            <!-- modaltk -->
                            <div class="modal fade" id="edittk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ url('ubahstrukturtk') }}" class="form-data" id="form-jadwal" enctype="multipart/form-data">
                                          @csrf
                                        <div>
                                        <label for="foto_struktur" class="control-label">Ganti Foto</label>
                                        <input name="foto_struktur" type="file" class="form-control">
                          ...
                          <div class="tab-pane" id="sd">
                            ...
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Foto Struktur</label>
                              <div class="col-sm-10">
                                <img class="w-50" src="{{ url('dashboard/img/struktur/'.$sd->foto_struktur) }}">
                              </div>
                            </div>
                            <!-- modalsd -->
                            <div class="modal fade" id="editsd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ url('ubahstruktursd') }}" class="form-data" id="form-jadwal" enctype="multipart/form-data">
                                          @csrf
                                        <div>
                                        <label for="foto_struktur" class="control-label">Ganti Foto</label>
                                        <input name="foto_struktur" type="file" class="form-control">
                          ...
                          <div class="tab-pane" id="smp">
                            ...
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Foto Struktur</label>
                              <div class="col-sm-10">
                                <img class="w-50" src="{{ url('dashboard/img/struktur/'.$smp->foto_struktur) }}">
                              </div>
                            </div>
                            <!-- modalsmp -->
                            <div class="modal fade" id="editsmp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ url('ubahstruktursmp') }}" class="form-data" id="form-jadwal" enctype="multipart/form-data">
                                          @csrf
                                        <div>
                                        <label for="foto_struktur" class="control-label">Ganti Foto</label>
                                        <input name="foto_struktur" type="file" class="form-control">
                          ...
                          <div class="tab-pane" id="sma">
                            ...
                            <div class="form-group row">
                              <label class="col-sm-2 col-form-label">Foto Struktur</label>
                              <div class="col-sm-10">
                                <img class="w-50" src="{{ url('dashboard/img/struktur/'.$sma->foto_struktur) }}">
                              </div>
                            </div>
                            <!-- modalsma -->
                            <div class="modal fade" id="editsma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{ url('ubahstruktursma') }}" class="form-data" id="form-jadwal" enctype="multipart/form-data">
                                          @csrf
                                        <div>
                                        <label for="foto_struktur" class="control-label">Ganti Foto</label>
                                        <input name="foto_struktur" type="file" class="form-control">
