        ...
        <div class="card">
          <div class="card-header card-header-success">
            <h4 class="card-title">PPDB SD
              ...
              <a href="{{ url('sd/exportsd') }}" target="_blank" class="btn btn-sm btn-white btn-round float-right" style="color: grey;"><i class="material-icons">print</i> Cetak</a>
            </h4>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Tambah Pendaftaran SD</h5>
        ...
        <div class="modal-body">
          <div class="card card-nav-tabs card-plain">
            ...
            <div class="card-body ">
              <form method="post" class="form-data" id="form-sd">
