      ...
      <div class="container-fluid heroProfilYayasan">
        <div class="row">
          <div class="col px-0">
            <img src="{{ url('dashboard/img/profil/'.$profilSD->foto_profil) }}" class="img-fluid mb-2 " alt="...">
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card mt-3">
              <div class="card-header text-center">
                <h2>{{ $profilSD->lembaga }}</h2>
                <p>Yayasan Pendidikan Tahfidz Az-Zumar</p>
              </div>
              <div class="card-body my-4">
                <p class="card-text ml">{!! $profilSD->isi_profil !!} </p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="card mt-3">
              ...
              <div class="card-body my-4 d-flex justify-content-center">
                <img src="{{ url('dashboard/img/struktur/'.$profilSD->foto_struktur) }}" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
